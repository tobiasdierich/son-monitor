...
class SntServicesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'sonata_srv_id', 'name', 'description', 'created', 'user', 'host_id')
...
class SntFunctionsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'sonata_func_id', 'name', 'description', 'created', 'service', 'host_id')
...
class SntNewFunctionsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = monitoring_functions
        fields = ('sonata_func_id', 'name', 'description', 'created', 'host_id', 'metrics',)
