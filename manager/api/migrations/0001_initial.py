# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-25 15:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='monitoring_functions',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('host_id', models.CharField(blank=True, max_length=30)),
                ('name', models.CharField(blank=True, max_length=30)),
                ('sonata_func_id', models.CharField(blank=True, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval', models.DecimalField(decimal_places=2, max_digits=6)),
                ('description', models.CharField(max_length=1024)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('function', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monitoring_functions')),
            ],
            options={
                'ordering': ('created',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=1024)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('notification_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monitoring_notif_types')),
            ],
            options={
                'ordering': ('created',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_id', models.CharField(blank=True, max_length=30)),
                ('name', models.CharField(blank=True, max_length=30)),
                ('sonata_srv_id', models.CharField(blank=True, max_length=30)),
                ('description', models.CharField(max_length=1024)),
                ('created', models.DateTimeField(auto_now_add=True)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monitoring_users'),
        ),
        migrations.AddField(
            model_name='monitoring_rules',
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monitoring_services'),
        ),
        migrations.AddField(
            model_name='monitoring_functions',
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.monitoring_services'),
        ),
    ]
