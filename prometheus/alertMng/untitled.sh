...
function configure(){
    ...
    echo -e "1.1-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
    ...
    echo -e "1.2-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
    ...
    echo -e "1.3-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
    ...
    echo -e "1.4-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
...
nat
echo -e "1-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
#Configure components
configure
echo -e "2-------------------------------------> DEFAULT_IP: "$DEFAULT_IP
